...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_product'])) {
    ...
    if (mysqli_query($con, $deleteQuery)) {
        header('Location: ./inventoryManagement.php?deleted=1');
        exit;
    } else {
...
<head>
    ...
    <meta name="keywords" content="blazor bootstrap, c# blazor, admin panel, blazor c#, template setting, admin, bootstrap admin template, blazor, blazorbootstrap, bootstrap 5 templates, setting, setting template bootstrap, admin setting bootstrap.">
    ...
    <link href="<?php echo PUBLIC_ASSETS; ?>css/vendor/order-details.css" rel="stylesheet">
...
<body>
    ...
    <div class="page">
        ...
        <div class="main-content app-content">
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-10 col-lg-10 col-md-12 col-sm-12">
                    <div class="d-flex align-items-center justify-content-between my-4 page-header-breadcrumb gap-3 flex-wrap">
                        ...
                        <div class="ms-md-1 ms-0">
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    ...
                                    ?>
                                    <li class="breadcrumb-item"><a href="./inventoryManagement.php">Inventory Management</a></li>
                                ...
                                <div class="col-xl-5 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="thumbnail-flex gap-3">
                                        <div class="thumbnail-container">
                                            <button class="btn-nav btn-up" id="thumbUp"><i class="fa-solid fa-chevron-up"></i></button>
                                            <div class="thumbnail-wrapper">
                                                ...
                                                // Parse videos (comma separated paths)
                                                ...
                                                if (empty($images) || !is_array($images)) {
                                                    $images = [ PUBLIC_ASSETS . 'images/vendor/Detail1s.png'];
                                                }
                                                ...
                                                foreach ($images as $index => $image) {
                                                    ...
                                                    echo '<div class="bright-shot-img">
                                                            <img src="'.(!empty($imagePath) ? PUBLIC_ASSETS . htmlspecialchars($imagePath) :  PUBLIC_ASSETS . 'images/vendor/default.png').'" alt="Thumbnail '.($thumbIndex + 1).'" class="thumbnail-img '.$isSelected.'" data-src="'.PUBLIC_ASSETS . htmlspecialchars($imagePath).'" data-type="image">
                                                          </div>';
                                                    $thumbIndex++;
                                                }
                                                ...
                                                foreach ($videos as $vIndex => $videoPath) {
                                                    ...
                                                    echo '<div class="bright-shot-img position-relative">
                                                            <video src="'. PUBLIC_ASSETS . htmlspecialchars($videoPath).'" class="thumbnail-img '.$isSelected.'" data-src="'. PUBLIC_ASSETS . htmlspecialchars($videoPath).'" data-type="video" muted preload="metadata" style="max-height:70px;object-fit:cover"></video>
                                            ...
                                            <button class="btn-nav btn-down" id="thumbDown"><i class="fa-solid fa-chevron-down"></i></button>
                                        </div>
                                        <div>
                                            <div class="bright-img">
                                                <button class="btn-main-nav btn-main-left" id="mainLeft"><i class="fa-solid fa-chevron-left"></i></button>
                                                <img src="<?php if(!empty($images[0])) { echo htmlspecialchars($images[0] ? PUBLIC_ASSETS . 'images/vendor/'.ltrim($images[0], PUBLIC_ASSETS) : PUBLIC_ASSETS . 'images/vendor/Detail1s.png'); } else { echo PUBLIC_ASSETS . 'images/vendor/default.png'; } ?>" alt="Main Image" class="main-img">
                                                <video class="main-video d-none" controls style="width:100%;height:auto;border-radius:8px"></video>
                                                <button class="btn-main-nav btn-main-right" id="mainRight"><i class="fa-solid fa-chevron-right"></i></button>
                                                <button class="btn-zoom-icon">
                                                    <img src="<?php echo PUBLIC_ASSETS; ?>images/vendor/zoom-icon.png" alt="Zoom Icon">
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-7 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div>
                                        <div class="product-detsail-heading">
                                            <h2><?php echo htmlspecialchars($product['product_name'] ?? 'Product Name'); ?></h2>
                                        </div>
                                        <div class="border-details"></div>
                                        <div>
                                            <div class="detail-price">
                                                <sup>₹</sup> <?php echo number_format((float)($product['selling_price'] ?? 0), 2); ?>
                                            </div>
                                            <div class="del-price mb-2">
                                                M.R.P: <del>₹<?php echo number_format((float)($product['mrp'] ?? 0), 2); ?></del> 
                                                <?php 
                                                    ...
                                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                                        <?php foreach ($variant['variants'] as $colorVariant): 
                                                            ...
                                                            <div class="color-one" data-variant-id="<?php echo $colorVariant['id']; ?>" 
                                                                 ...
                                                                 title="<?php echo htmlspecialchars($colorName); ?>"></div>
                                                        <?php endforeach; ?>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                        ...
                                        <div>
                                            <div class="cataegory-product">
                                                <h4>Category: <span><?php echo htmlspecialchars($product['category_name'] ?? 'N/A'); ?> || <?php echo htmlspecialchars($product['sub_category_name'] ?? 'N/A'); ?></span></h4>
                                            </div>
                                            
                                            <div class="cataegory-product">
                                                <h4 class="pt-0">SKU: <span><?php echo htmlspecialchars($product['sku_id'] ?? 'N/A'); ?></span></h4>
                                            </div>
                                ...
                                <div class="col-12">
                                    <div class="product-details-tab">
                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Customer Reviews (<?php 
                                                $get_reviews = mysqli_query($con, "SELECT * FROM reviews WHERE product_id = '$product_id'");
                                                $total_reviews = mysqli_num_rows($get_reviews);
                                                echo $total_reviews;
                                                //echo rand(5, 25); ?>)</button>
                                            </li>
                                        </ul>
                                        <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                                                ...
                                                <div class="modal-product-details">
                                                    <h4><?php echo htmlspecialchars($attributeNames[$variant['attribute_id']] ?? 'Attribute'); ?></h4> 
                                                    <span>
                                                        <?php 
                                                        $variantNamesList = [];
                                                        if (isset($variant['variants']) && is_array($variant['variants'])) {
                                                ...
                                                <div>
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div class="progress">
                                                            ...
                                                            ?>
                                                            <div class="progress-bar" role="progressbar" aria-label="Basic example" style="width: <?php echo $percentage; ?>%" aria-valuenow="<?php echo $percentage; ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                                                        <div>
                                               ...
                                               <div class="col-xl-7 col-lg-12 col-md-12 col-sm-12 col-12">
                                                 <div class="user-detail-flex">
                                                    <div class="user-detail">
                                                        <img src="<?php echo PUBLIC_ASSETS; ?>images/vendor/user.png" alt="">
                                                    </div>
                                                    <div class="user-name">
                                        ...
                                        <div class="text-end">
                                            <button class="btn btn-delete-dtsil" data-bs-toggle="modal" data-bs-target="#cancelOrderModal">Delete</button>
                                            <a href="./first-edit-product.php?id=<?php echo $product_id; ?>"><button class="btn btn-edit-dtsil">Edit</button></a>
                                        </div>
        ...
        <footer class="footer mt-auto py-3 bg-white text-center">
            <div class="container">
                <span class="text-muted">Copyright © 2025 <span id="year"></span> <a href="#" class="text-primary fw-semibold">Hagidy</a>.
    ...
    <script>
        // Get all thumbnails (img or video)
