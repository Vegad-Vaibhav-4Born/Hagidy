  ...
  (function (t) {
    ...
    (Wolmart.$window = t(window)),
      ...
      (Wolmart.minipopupOption = {
        ...
        space: 20,
        template:
          '<div class="minipopup-box"><div class="product product-list-sm {{productClass}}"><figure class="Shopping Cart"><a href="{{imageLink}}"><img src="{{imageSrc}}" alt="Product" width="80" height="90" /></a></figure><div class="product-details"><h4 class="product-name"><a href="{{nameLink}}">{{name}}</a></h4>{{message}}</div></div><div class="product-action">{{actionTemplate}}</div></div>',
      }),
      (Wolmart.Minipopup =
        ((i = 0),
        (a = []),
                  ...
                  setTimeout(function () {
                    i.removeClass("load-more-overlay loading"),
                      Wolmart.Minipopup.open({
                        ...
                        actionTemplate:
                          '<a href="cart.php" class="btn btn-rounded btn-sm">View Cart</a><a href="cart.php" class="btn btn-dark btn-rounded btn-sm">Checkout</a>',
                      });
                  }, 500));
            }
          ),
